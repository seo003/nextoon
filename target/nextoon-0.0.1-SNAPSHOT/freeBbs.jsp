...
<div id="main">
    ...
    <article class="post">
        <header>
            <div class="title">
                <h2>
                    <a href="recommendBbs.jsp">자유게시판</a>
                </h2>
                <p>웹툰에 대해 하고싶은말을 뭐든지 적어주세요!</p>
                <a href="bbsWrite.jsp?bbsType=free" class="button large next" onclick="return isLogin('<%=loginId%>')">글쓰기</a>
            </div>
        </header>
        <div class="table-wrapper">
            <table>
                ...
                <%
                    ...
                    ArrayList<BbsDTO> list = bbsDAO.getFreeList(pageNumber);
                    if (list.isEmpty()) {
                %>
                    <tr>
                ...
                <tr>
                    ...
                    <td class="tdLike"><%=list.get(i).getLikeCount()%></td>
                </tr>
                <%}%>
                </tbody>
            </table>
