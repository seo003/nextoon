...
<div id="main">
	...
	<article class="post">
		...
		<p>Nunc quis dui scelerisque, scelerisque urna ut, dapibus orci.
			...
			mattis justo. Integer sed sapien fringilla, dapibus risus id,
			faucibus ante. Pellentesque mattis nunc sit amet tortor pellentesque,
			non placerat neque viverra.</p>
		<footer>
			<ul class="stats">
